...
with open("../comments/state_of_union/tokenized_comments.json", "r") as json_file:
...
csv_file = "../comments/state_of_union/word_frequency.csv"
...
word_frequencies = load_from_csv("../comments/state_of_union/word_frequency.csv")
