...
with open("../comments/comments2/tokenized_comments.json", "r") as json_file:
...
csv_file = "../comments/comments2/word_frequency.csv"
...
word_frequencies = load_from_csv("../comments/comments2/word_frequency.csv")
